...
proc vTclWindow.top1 {base} {
    ...
    label $top.lab46 \
        ...
        -foreground $vTcl(actual_gui_fg) -text {Lobby ID: } 
    vTcl:DefineAlias "$top.lab46" "IDLabel" vTcl:WidgetProc "Toplevel1" 1
    entry $top.ent47 \
    ...
    button $top.but48 \
        ...
        -pady 0 -text Connect 
    vTcl:DefineAlias "$top.but48" "ConnectButton" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.lab46 \
        -in $top -x 0 -relx 0.183 -y 0 -rely 0.289 -width 0 -relwidth 0.24 \
        -height 0 -relheight 0.091 -anchor nw -bordermode ignore 
    place $top.ent47 \
        -in $top -x 0 -relx 0.383 -y 0 -rely 0.289 -width 284 -relwidth 0 \
        -height 40 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but48 \
        -in $top -x 0 -relx 0.25 -y 0 -rely 0.556 -width 307 -relwidth 0 \
