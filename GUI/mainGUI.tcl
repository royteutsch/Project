...
#  May 12, 2022 10:24:57 AM +0300  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 885x531+355+96
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    canvas $top.can46 \
        ...
        -height 503 -highlightbackground $vTcl(actual_gui_bg) \
        -highlightcolor black -insertbackground black -relief ridge \
        -selectbackground blue -selectforeground white -width 633 
    vTcl:DefineAlias "$top.can46" "Canvas" vTcl:WidgetProc "Toplevel1" 1
    frame $top.fra48 \
    ...
    checkbutton $site_4_0.che46 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -selectcolor #d9d9d9 -text Active -variable che46 
    vTcl:DefineAlias "$site_4_0.che46" "TimeFilterCheck" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $site_4_0.che46 \
        -in $site_4_0 -x 0 -relx 0.069 -y 0 -rely 0.522 -width 0 \
        -relwidth 0.421 -height 0 -relheight 0.217 -anchor nw \
        -bordermode ignore 
    ...
    checkbutton $site_4_0.che47 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -selectcolor #d9d9d9 -text Active -variable che47 
    vTcl:DefineAlias "$site_4_0.che47" "ColourFilterCheck" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $site_4_0.che47 \
        -in $site_4_0 -x 0 -relx 0.276 -y 0 -rely 0.345 -width 0 \
        -relwidth 0.421 -height 0 -relheight 0.172 -anchor nw \
        -bordermode ignore 
    ...
    checkbutton $site_4_0.che48 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -selectcolor #d9d9d9 -text Active -variable che48 
    vTcl:DefineAlias "$site_4_0.che48" "UserFilterCheck" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $site_4_0.che48 \
        -in $site_4_0 -x 0 -relx 0.276 -y 0 -rely 0.424 -width 0 \
        -relwidth 0.421 -height 0 -relheight 0.152 -anchor nw \
        -bordermode ignore 
    checkbutton $site_3_0.che49 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -selectcolor #d9d9d9 -text {Active All} -variable che49 
    vTcl:DefineAlias "$site_3_0.che49" "ActivateAllFilter" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $site_3_0.che49 \
        -in $site_3_0 -x 0 -relx 0.207 -y 0 -rely 0.119 -width 0 \
        -relwidth 0.559 -height 0 -relheight 0.05 -anchor nw \
        -bordermode ignore 
    frame $top.fra49 \
        -borderwidth 2 -relief groove -background $vTcl(actual_gui_bg) \
        -height 445 -highlightbackground $vTcl(actual_gui_bg) \
        -highlightcolor black -width 85 
    ...
    place $site_3_0.but52 \
        -in $site_3_0 -x 0 -y 0 -rely 0.202 -width 87 -relwidth 0 -height 94 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but53 \
        -in $site_3_0 -x 0 -y 0 -rely 0.404 -width 87 -relwidth 0 -height 94 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but54 \
        -in $site_3_0 -x 0 -y 0 -rely 0.607 -width 87 -relwidth 0 -height 94 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but55 \
        -in $site_3_0 -x 0 -y 0 -rely 0.809 -width 87 -relwidth 0 -height 94 \
        -relheight 0 -anchor nw -bordermode ignore 
    button $top.but47 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -compound left \
    ...
    ###################
    place $top.can46 \
        -in $top -x 0 -relx 0.102 -y 0 -rely 0.019 -width 0 -relwidth 0.715 \
        -height 0 -relheight 0.947 -anchor nw -bordermode ignore 
    place $top.fra48 \
        -in $top -x 0 -relx 0.825 -y 0 -rely 0.019 -width 0 -relwidth 0.164 \
        -height 0 -relheight 0.951 -anchor nw -bordermode ignore 
    place $top.fra49 \
        -in $top -x 0 -y 0 -rely 0.038 -width 0 -relwidth 0.096 -height 0 \
        -relheight 0.838 -anchor nw -bordermode ignore 
    place $top.but47 \
        -in $top -x 0 -relx 0.723 -y 0 -rely 0.791 -width 79 -relwidth 0 \
